...
// 连接数组：join()
// --------------------------------------------------------------------------------
console.log(colors.join());     // blue,white,yellow,black,blue
console.log(colors.join("-"));  // blue-white-yellow-black-blue
...
console.log({a, b, c, d, e});   // { a: 'blue', b: 'white', c: 'yellow', d: 'black', e: 'blue' }

const [x, y, ...g] = colors;
console.log({x, y, g}); // { x: 'blue', y: 'white', g: [ 'yellow', 'black', 'blue' ] }

let foo, baz;
[foo, baz] = [1, 2];
console.log({foo, baz});    // { foo: 1, baz: 2 }
...
console.log([1, 2, 3, ...colors]);
// 字符串展开
console.log([1, 2, ..."abc"]); // [ 1, 2, 'a', 'b', 'c' ]


// ------------------------------------------------------------------------------
// 数组 at() 方法，正数时从0下标取值，负数从-1 开始取值，-1 等于最后一个元素
// ------------------------------------------------------------------------------
console.log(colors.at(0));  // blue
console.log(colors.at(-1)); // blue
console.log(colors.at(-1) == colors.at(0)); // true


// ------------------------------------------------------------------------------
// 数组排序： toReversed() 反转数组，但不更改原始数组
// ------------------------------------------------------------------------------
console.log(colors.toReversed());   // [ 'blue', 'black', 'yellow', 'white', 'blue' ]
